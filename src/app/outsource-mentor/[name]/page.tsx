            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-yellow-300 transition-all duration-200">
                  ...
                  <span className="min-w-0 text-right text-sm font-bold text-gray-900">{outsource?.outsourceAddr || '정보 없음'}</span>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2">
                  <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-yellow-300 transition-all duration-200">
                    ...
                    <span className="min-w-0 text-right text-sm font-bold text-gray-900">{outsource?.outsourceType || '정보 없음'}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-yellow-300 transition-all duration-200">
                    ...
                    <span className="min-w-0 text-right text-sm font-bold text-gray-900">{outsource?.outsourceCEO || '정보 없음'}</span>
                  </div>
                </div>
