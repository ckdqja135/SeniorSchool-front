...
import GenericEntityTable from '@/components/feature/services/admin/GenericEntityTable';
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">
          {config.serviceEmoji} {config.serviceDisplay} 관리
        </h1>
        <p className="text-sm text-gray-500 mt-1">
          엔티티 데이터를 추가, 수정, 삭제할 수 있습니다.
        </p>
      </div>

      <GenericEntityTable config={config} slug={serviceSlug} />
    </div>
  );
}
