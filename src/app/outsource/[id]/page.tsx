                  ...
                  boards.map((board) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-lg font-medium text-gray-900 flex-1">{board.title}</h3>
                        <span className="text-sm text-gray-500 ml-4">{formatTimeAgo(board.createdAt)}</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          <span>{board.writerName || board.writerId}</span>
                        </div>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
