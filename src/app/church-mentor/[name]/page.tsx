            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-red-200 transition-all duration-200">
                  ...
                  <span className="min-w-0 text-right text-sm font-bold text-gray-900">{church.churchLocation}</span>
                </div>
                ...
                <div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2">
                  <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-red-200 transition-all duration-200">
                    ...
                    <span className="min-w-0 text-right text-sm font-bold text-gray-900">{church.churchType}</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-100 hover:border-red-200 transition-all duration-200">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="shrink-0 whitespace-nowrap text-sm text-gray-500 font-medium">담임목사</span>
                  </div>
                  <span className="min-w-0 text-right text-sm font-bold text-gray-900">{church.churchPastor}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-2 sm:gap-2 md:gap-3">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 sm:px-3 md:px-6 sm:py-1.5 md:py-2.5 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center gap-1 sm:space-x-1 md:space-x-2"
                  >
