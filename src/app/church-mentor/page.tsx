      ...
      <div className="bg-white py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* 인기 교회 섹션 */}
            <div className="relative">
              {/* 교회 추가 요청 버튼 - 섹션 왼쪽 바깥쪽 */}
              <div className="absolute -left-48 top-0">
                <button
                  type="button"
                  onClick={() => setShowRequestModal(true)}
                  className="flex items-center space-x-2 px-3 py-1.5 rounded-lg transition-all duration-300 bg-red-100 text-red-600 hover:bg-red-200"
                >
                  <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                  </svg>
                  <span className="text-sm">교회 추가 요청</span>
                </button>
              </div>
